...
namespace PTImmo_2018
{
	public partial class PropositionBien : Form
	{
		...
		private void PropositionBien_Load(object sender, EventArgs e)
		{
			...
			string sql = "select s.CODE_SOUHAIT, v.NOM_VILLE, s.SURFACE_HABITABLE_MIN, s.SURFACE_PARCELLE_MIN, s.NB_PIECES_MIN, s.PRIX_MAX, s.STATUT from SOUHAIT s left join VILLE v on v.CODE_VILLE = s.CODE_VILLE where s.NUM_ACHETEUR = ";
